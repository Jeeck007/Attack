...
echo $e"|       BY : Jecko / Mr.Jeeck            |"
echo $e"|Jangan Lupa Suport terus Aing yeee      |"
...
sleep 2
echo $cy"Jangan lupa bismillah bro ^_^"
sleep 2
echo $cy"Kalau Ada error silahkan hubungi saya di WA"
sleep 2
echo $i"Youtube : Nggak punya "
echo $i"Whatsapp : 081392505882 "
fi
